<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Admin — Found Items</h2>
    </x-slot>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 text-xs">{{ $item->location_found }}</td>
                        <td class="px-4 py-3">
                        ...
                        <td class="px-4 py-3">
                            <form method="POST" action="{{ route('admin.items.status', ['type' => 'found', 'id' => $item->id]) }}"
                                  class="flex gap-1">
                                @csrf
                    ...
                    @empty
                    <tr>
                        <td colspan="7" class="px-4 py-8 text-center text-gray-500">No found items yet.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
